...
public class Main {
  ...
  public void run(RuntimeSettings runtimeSettings) {
    ...
    ImageProcessor pinkHouseImageProcessor = PinkHouseImageProcessorFactory.CreateImageProcessor(publishingTable);
    ...
    while (!Thread.currentThread().isInterrupted()) {
      if (!inputImage.empty()) {
        ...
        pinkHouseImageProcessor.processAsync(inputImage);
        ...
        pinkHouseImageProcessor.awaitProcessCompletion();
